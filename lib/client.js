/**
 * @local/dsh-plugin-voice-input — client bundle (阿里云 DashScope ASR 本地桥接版).
 *
 ...
 *
 * Engine: local Python bridge (D:\DS-work\voice-bridge.py) which calls
					...
					this.workletNode.port.onmessage = (e) => {
						...
						try {
							...
							if (rms > 200) {
								...
								// 静音累计
								if (self.lastSpeechTime > 0) {
									self.silenceMs += 300; // 每 300ms 一段
									if (self.silenceMs >= 1500 && self.recording) {
										// 连续静音 1.5 秒 → 自动停止
										self.silenceMs = 0;
			...
			return h("span", { className: "dvi-group", "data-voice-input": "" },
				...
				menuOpen && h("div", {
					...
					h("div", { className: "dvi-menuRow" },
						...
						h("span", { className: "dvi-menuLabel", style: { fontSize: "11px", color: "var(--dsw-alias-label-tertiary, #9aa0aa)" } }, "需运行 D:\\DS-work\\voice-bridge.py"),
					),
					h("div", { className: "dvi-menuRow" },
